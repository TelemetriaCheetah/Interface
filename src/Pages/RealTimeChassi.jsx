...
export const RealTimeMechanics = () => 
{
    ...
    const [sensorIncomingData , setSensorIncomingData] = React.useState({SA1 : 0 , SA2: 0 , SA74 : 0 , SA76: 0 , SA4: 0, SA8: 8, SA9:0 , SA22:0 });
    ...
    return (
        <Grid container spacing={0} className = {classes.grid}>
            ...
            <Grid item xs={3} ><Wheel titulo={"Encoder Volante"}></Wheel></Grid>
            <Grid item xs={7} ><Graph titulo={"Gráfico"} temp={brakeTempValues.SA8}></Graph></Grid>
